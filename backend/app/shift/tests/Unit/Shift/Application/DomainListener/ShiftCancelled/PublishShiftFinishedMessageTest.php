...
namespace App\Tests\Unit\Shift\Shift\Application\DomainListener\ShiftCancelled;

use App\Shared\Domain\Service\UserEmailProviderInterface;
use App\Shift\Shift\Application\DomainListener\ShiftCancelled\PublishShiftFinishedMessage;
...
final class PublishShiftFinishedMessageTest extends TestCase
{
    ...
    #[Test]
    public function publishes_finished_message_with_the_cancellation_reason(): void
    {
        ...
        ($this->listener)(new ShiftCancelled(
            shiftId: $shiftId,
