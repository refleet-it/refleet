...
#[CoversClass(PasswordResetTokenExpiredException::class)]
#[UsesClass(AppException::class)]
final class PasswordResetTokenExpiredExceptionTest extends TestCase
{
    #[Test]
    public function should_extend_app_exception_and_set_message(): void
    {
        ...
        Assert::assertSame('Password reset token has expired.', $exception->getMessage());
    }
    ...
    {
        // Arrange & Act
        $reflection = new \ReflectionClass(PasswordResetTokenExpiredException::class);
