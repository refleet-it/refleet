...
final class AccountNotFoundExceptionTest extends TestCase
{
    #[Test]
    public function should_extend_not_found_exception_and_set_message(): void
    {
        ...
        Assert::assertSame('Account not found', $exception->getMessage());
    }
    ...
    {
        // Arrange & Act
        $reflection = new \ReflectionClass(AccountNotFoundException::class);
